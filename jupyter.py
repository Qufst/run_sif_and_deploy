...
def run_server_subprocess(options, status):
    # Use the Apptainer Python executable
    python_exe = "/home/runner/work/run_sif_and_deploy/run_sif_and_deploy/apptainer-scripts/python"
...
def run_notebook(options, status):
    # Use the Apptainer Jupyter executable
    jupyter_exe = "/home/runner/work/run_sif_and_deploy/run_sif_and_deploy/apptainer-scripts/jupyter"
